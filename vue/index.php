...
<section>
    <div class="row">
     ...
     <div >
        ...
        <h1 class="centrer" style="color:white">Bienvenue chez Swappist !</h1>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 product-cart">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-6 text-right product-add-cart">
                                ...
                                <a href="#" class="btn btn-success">JE SWAPPE</a>
                ...
                <div class="row product-part">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 product-description">
                        ...
                        <p>J'échange à regret ma Twingo Kenzo 1998 tunée (123 456 789 km, CT OK, pneus neufs,
                            ...
                            peinture effet Velvet) contre ce que vous voulez, mon mari ne la supporte plus...

                            Sinon je swappe mon mari contre prise en charge des frais de divorce.
    ...
    <div class="row" style="margin-bottom:15px">
        ...
        <div class="col-sm-4">
            ...
            <div class="panel panel-default" id="slogan">
                ...
                <div class="panel-body" style="font-size:20px">Négociez le Swapp (objet + SouApp)</div>
