...
<form method="post" action="includes/postok.php?action=repondre&amp;t=<?php echo $topic ?>" name="formulaire">
...
break;
    ...
    case "nouveautopic": //Deuxième cas : on souhaite créer un nouveau topic
        ...
        ?>
<h1>Nouveau topic</h1>
<form method="post" action="includes/postok.php?action=nouveautopic&amp;f=<?php echo $forum ?>" name="formulaire">
